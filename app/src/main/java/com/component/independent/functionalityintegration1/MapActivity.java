...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public boolean servicesAvailable() {
        ...
        int isAvailable = googleApiAvailability.isGooglePlayServicesAvailable(MapActivity.this);
    ...
    private void updateETA(Location location) {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(MapActivity.this, "ETA : " + mins_duration + "minutes", Toast.LENGTH_SHORT).show();
                            if(mins_duration<1){
                                updateServer();
                            }
        ...
        MySingletonMaps.getInstance(MapActivity.this).addToQueue(jsonObjectRequest);

    }

    private void updateServer() {
        RequestQueue req = Volley.newRequestQueue(MapActivity.this);
            ...
            AlertDialog adb = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            setValues(location);
                            Toast.makeText(MapActivity.this, "Home set at " +
                    ...
                    .setNegativeButton("No", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(MapActivity.this, "Home not set", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .create();
            adb.show();
